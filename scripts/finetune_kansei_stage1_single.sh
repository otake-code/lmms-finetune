...
TRAIN_DATA_PATH=jsons/train0_finetune_data_onevision.jsonl # path to the training data json file
...
torchrun $DISTRIBUTED_ARGS train_add_head.py \
    ...
    --no_use_lora \
    --no_use_vision_lora \
    --stage1 True  # Stage1 モード：Yes/No 判定ヘッド＋Vision Projector のみ学習
